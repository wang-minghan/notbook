...
keywords:
  ...
  - 笔记样式
note-status: archive
source: https://pkmer.cn/Pkmer-Docs/10-obsidian/obsidian%E7%A4%BE%E5%8C%BA%E6%8F%92%E4%BB%B6/obsidian-columns/
author: OS
type: readme
---

> ## Excerpt
> Obsidian Columns插件可以在Obsidian中创建列。它还可以在移动端使用列包装功能（可以在设置中启用）。插件添加了特殊的列表语法来创建列，还添加了两种代码块语言：col和col-md。col-md代码块只是普通的Markdown，col代码块将每个Markdown元素渲染为自己的列。插件还提供了col和col-md提示来创建列，而不需要使用JavaScript。使用col提示创建一个列，使用col-md提示在col提示内创建一个列。插件的使用场景包括在Obsidian中创建多列布局，解决了原生Markdown无法直接创建多列布局的问题。可以通过设置块来自定义列的高度、宽度和文本对齐方式。未来的功能包括为编辑器启用语法高亮和为每个列组和列设置自定义设置。

---
Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式

[OS](https://pkmer.cn/authors/os) 于  2023-09-21 16:18  发布

分享

___

Obsidian Columns插件可以在Obsidian中创建列。它还可以在移动端使用列包装功能（可以在设置中启用）。插件添加了特殊的列表语法来创建列，还添
...
![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--样式&效果](https://cdn.pkmer.cn/covers/obsidian-columns.PNG!pkmer)
...
![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--使用类 callou 来书写多栏](https://cdn.pkmer.cn/images/20230612113637.png!pkmer)

![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--使用类 callou 来书写多栏](https://cdn.pkmer.cn/images/20230612113735.png!pkmer)
...
-   效果 ![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--使用类 callou 来书写多栏](https://cdn.pkmer.cn/images/20230612114241.png!pkmer)
...
![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--使用类 代码域语法 来书写多栏|701x175](https://cdn.pkmer.cn/images/20230612114809.png!pkmer)

### 复合分栏示例

-   效果 ![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--复合分栏示例|740x255](https://cdn.pkmer.cn/images/20230612115317.png!pkmer)
-   语法
...
![Obsidian 插件：Obsidian Columns 支持分栏书写美化你的笔记样式--复合分栏示例](https://cdn.pkmer.cn/images/20230612115428.png!pkmer)
...
> -   [lapel](https://pkmer.cn/Pkmer-Docs/10-obsidian/obsidian%E7%A4%BE%E5%8C%BA%E6%8F%92%E4%BB%B6/lapel)：在标题旁边显示标题等级，并提供快捷切换标题等级的能力
