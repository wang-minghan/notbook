...
### 项目背景
> 公司内部需要自研 Agent 能力，解决推理不可控、幻觉、上下文遗忘等模型通病，于是参考美国军工企业 Pylinuter 的思路，搭建本体知识图谱，对企业知识做结构化管理。

### 我的角色
> 我主导了多 Agent 协同工作流、状态管理和数据库设计。

### 落地价值
> 这个方案在原有工作流里显著提升了执行效率，也让推理过程更可控、更稳定，便于企业知识沉淀和复用。

### 竞争力
> 同期产品表现优异，说明方案不仅能做出来，而且在实际对比中有竞争力。

### 面试说
> 亚信这个项目的核心，是把 Agent 的不可控问题收进结构化知识图谱和多 Agent 工作流里；我负责的是协同工作流、状态管理和数据库设计，最后在企业落地里把效率和稳定性都拉起来了。
