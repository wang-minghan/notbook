...
必须显式约束：
- **标题安全区**：为标题和副标题保留一大片干净留白
- **视觉重心偏置**：把主体或发光焦点放到文本区的对侧
...
- 不必像封面那样保留超大标题区
- 但仍要避免伪文字、假 UI、假海报排版中的文字内容
- 主体可以更明确，但仍应保持单一视觉中心
- 优先生成“可嵌入页面的视觉资产”，而不是自带大字与版式的成品海报
- 如果是概念插图，允许更强叙事性；如果是背景插图，优先降低复杂度
- **可以有海报感的构图与电影感氛围，但必须保持“无文字素材图”**：允许电影海报式的光影、景别、戏剧张力与版式节奏，但要压掉标题、字幕、演职员表、标语、宣传文案等一切文字元素
